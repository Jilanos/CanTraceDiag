## item_011_p1_durcir_securite_locale - P1 Durcir securite locale
> From version: 1.0.0
> Schema version: 1.0
> Status: Obsolete
> Understanding: 100%
...
# AC Traceability
- request-AC11 -> This backlog slice. Proof: AC11: L'API rejette les requêtes dont le Host n'est pas dans l'allowlist locale et
...
- Superseded by: `item_019_harden_local_and_lan_api_security`

# AI Context
- Summary: P1 Durcir securite locale
- Keywords: backlog-groom, request, p1 durcir securite locale, bounded slice
- Use when: Use when implementing or reviewing the delivery slice for P1 Durcir securite locale.
...
# Tasks
- `task_012_p1_durcir_securite_locale`
