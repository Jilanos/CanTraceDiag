...
# AC Traceability
- request-AC13 -> This backlog slice. Proof: AC13: Une ligne ASC tronquée ou avec attributs de fin de ligne produit un événement
- request-AC14 -> This backlog slice. Proof: AC14: `pyarrow` et `python-can` sont utilisés ou retirés ; le code mort identifié
- request-AC15 -> This backlog slice. Proof: AC15: La CI échoue si les E2E sont skippés faute de navigateur, et protège un budget
...
- Keywords: backlog-groom, request, p2 reduire dette parsing maintenance ci, bounded slice
- Use when: Use when implementing or reviewing the delivery slice for P2 Reduire dette parsing maintenance CI.
...
# Tasks
- `task_013_p2_reduire_dette_parsing_maintenance_ci`
