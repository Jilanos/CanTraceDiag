...
- [x] Remaining scope is carried by `task_018_bound_hot_endpoints_and_deterministic_trace_navigation`.
...
- Superseded by: `task_018_bound_hot_endpoints_and_deterministic_trace_navigation`
